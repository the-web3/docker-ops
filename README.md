...
![图片1][Photo]
[Photo]:https://github.com/guoshijiang/docker-virtual-technology/blob/master/images/1.jpg "图片1"
* 双击Docker.app启动Docker，
![图片2][Photo]
[Photo]:https://github.com/guoshijiang/docker-virtual-technology/blob/master/images/2.jpg "图片2"

蓝鲸的头状态条表Docker正在运行，并且是可以从终端进入的。如果你已经安装了这个app，你也会获得暗示下一步成功的消息和链接到这个文档，点击蓝鲸图标在状态条上有下图这样一个显示和弹出

![图片3][Photo]
[Photo]:https://github.com/guoshijiang/docker-virtual-technology/blob/master/images/3.jpg "图片3"

* 点击鲸获取参数和其他选项
![图片4][Photo]
[Photo]:https://github.com/guoshijiang/docker-virtual-technology/blob/master/images/4.jpg "图片4"
